...
srun -p t1small --time=1:00:00 bash 1301-processPileup.sh bamlists/36.bamlist genome/GCF_000721915.3_Eluc_V3_genomic.fna

Certainly seems to take a while.
...
Our RAD loci:
```{r}
dfCC %>% select(chrom, leftEnd, rightEnd, length)
write_csv(dfCC, "outputs/1300/rad-loci.csv")
```
