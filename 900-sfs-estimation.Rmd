...
/Users/mac/angsd/misc/realSFS outputs/900/test.saf.idx -maxIter 100 -P 2 > outputs/900/test-realSFS.stdout >> outputs/900/test-realSFS.stderr
```

#### Step 2 Per-Site Thetas  

```{sh, eval=FALSE}
/Users/mac/angsd/angsd -bam data/test/bam.filelist -out outputs/900/test-realSFS.stdout -doThetas 1 -doSaf 1 -pest outputs/900/test.sfs -anc genome/chimpHg19.fa -GL 1
